...
namespace SkyrimScripting::Messages {
    const char* MessageImpl::GetSender() const { return _sender.c_str(); }
    const char* MessageImpl::GetText() const { return _text.c_str(); }
    void*       MessageImpl::GetData() const { return _data; }
    bool        MessageImpl::IsResponse() const { return _isResponse; }
    bool        MessageImpl::IsRequest() const { return _isRequest; }
    CallbackID  MessageImpl::GetReplyID() const { return _replyId; }
